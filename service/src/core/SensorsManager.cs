...
namespace LibreHardwareService
{
	internal class SensorsManager
	{
		...
		public void UpdateHardwareSensors()
		{
			...
			{
				sensor.ValuesTimeWindow = sensorsTimeWindow;
			}));
...
#pragma warning restore CS8629 // Nullable value type may be null.
							...
							index.Add(new DataIndex { Identifier = s.Identifier.ToString(), Size = sensorData.Length, Offset = offset, SensorName = s.Name, SensorType = s.SensorType.ToString(), HardwareName = s.Hardware.Name });
